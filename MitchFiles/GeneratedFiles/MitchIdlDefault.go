...
// MitchAlpha reader
func Read_MitchAlpha(stream Streams.IMitchReader) (Streams.MitchAlpha, int, error) {
...
// MitchBitField reader
func Read_MitchBitField(stream Streams.IMitchReader) (Streams.MitchBitField, int, error) {
...
// MitchByte reader
func Read_MitchByte(stream Streams.IMitchReader) (Streams.MitchByte, int, error) {
...
// MitchDate reader
func Read_MitchDate(stream Streams.IMitchReader) (Streams.MitchDate, int, error) {
...
// MitchTime reader
func Read_MitchTime(stream Streams.IMitchReader) (Streams.MitchTime, int, error) {
...
// MitchPrice04 reader
func Read_MitchPrice04(stream Streams.IMitchReader) (Streams.MitchPrice04, int, error) {
...
// MitchPrice08 reader
func Read_MitchPrice08(stream Streams.IMitchReader) (Streams.MitchPrice08, int, error) {
...
// MitchUInt08 reader
func Read_MitchUInt08(stream Streams.IMitchReader) (Streams.MitchUInt08, int, error) {
...
// MitchUInt16 reader
func Read_MitchUInt16(stream Streams.IMitchReader) (Streams.MitchUInt16, int, error) {
...
// MitchUInt32 reader
func Read_MitchUInt32(stream Streams.IMitchReader) (Streams.MitchUInt32, int, error) {
...
// MitchUInt64 reader
func Read_MitchUInt64(stream Streams.IMitchReader) (Streams.MitchUInt64, int, error) {
