...
// TEventCode writer 
func Write_TEventCode(stream Streams.IMitchWriter, value TEventCode) (byteCount int, err error) {
	var n int 
	return byteCount, nil
}
...
func Write_MitchMessage_SystemEvent(stream Streams.IMitchWriter, value *MitchMessage_SystemEvent) (byteCount int, err error) {
	...
	byteCount += n
	n, err = Write_TEventCode(stream, value.EventCode)
	if err != nil {
		return 0, err
	}
	byteCount += n
...
func Read_MitchMessage_SystemEvent(stream Streams.IMitchReader) (value *MitchMessage_SystemEvent, byteCount int, err error) {
	...
	byteCount += n
	value.EventCode, n, err = Read_TEventCode(stream)
	if err != nil {
		return nil, 0, err
	}
	byteCount += n
...
func Write_SymbolDirectorySymbolStatus(stream Streams.IMitchWriter, value SymbolDirectorySymbolStatus) (byteCount int, err error) {
	var n int 
	return byteCount, nil
}
...
func Read_SymbolDirectorySymbolStatus(stream Streams.IMitchReader) (value SymbolDirectorySymbolStatus, byteCount int, err error) {
	value = NewSymbolDirectorySymbolStatus()
	var n int 
	return value, byteCount, nil
}
...
func Write_SymbolDirectoryOptionType(stream Streams.IMitchWriter, value SymbolDirectoryOptionType) (byteCount int, err error) {
	var n int 
	return byteCount, nil
}
...
func Read_SymbolDirectoryOptionType(stream Streams.IMitchReader) (value SymbolDirectoryOptionType, byteCount int, err error) {
	value = NewSymbolDirectoryOptionType()
	var n int 
	return value, byteCount, nil
}
...
func Write_SymbolDirectorySettlementMethod(stream Streams.IMitchWriter, value SymbolDirectorySettlementMethod) (byteCount int, err error) {
	var n int 
	return byteCount, nil
}
...
func Read_SymbolDirectorySettlementMethod(stream Streams.IMitchReader) (value SymbolDirectorySettlementMethod, byteCount int, err error) {
	value = NewSymbolDirectorySettlementMethod()
	var n int 
	return value, byteCount, nil
}
...
func Write_MitchMessage_SymbolDirectory(stream Streams.IMitchWriter, value *MitchMessage_SymbolDirectory) (byteCount int, err error) {
	...
	byteCount += n
	n, err = Write_SymbolDirectorySymbolStatus(stream, value.SymbolStatus)
	if err != nil {
		return 0, err
	}
	byteCount += n
	...
	byteCount += n
	n, err = Write_SymbolDirectoryOptionType(stream, value.OptionType)
	if err != nil {
		return 0, err
	}
	byteCount += n
	...
	byteCount += n
	n, err = Write_SymbolDirectorySettlementMethod(stream, value.SettlementMethod)
	if err != nil {
		return 0, err
	}
	byteCount += n
...
func Read_MitchMessage_SymbolDirectory(stream Streams.IMitchReader) (value *MitchMessage_SymbolDirectory, byteCount int, err error) {
	...
	byteCount += n
	value.SymbolStatus, n, err = Read_SymbolDirectorySymbolStatus(stream)
	if err != nil {
		return nil, 0, err
	}
	byteCount += n
	...
	byteCount += n
	value.OptionType, n, err = Read_SymbolDirectoryOptionType(stream)
	if err != nil {
		return nil, 0, err
	}
	byteCount += n
	...
	byteCount += n
	value.SettlementMethod, n, err = Read_SymbolDirectorySettlementMethod(stream)
	if err != nil {
		return nil, 0, err
	}
	byteCount += n
...
func Write_SymbolStatusTradingStatus(stream Streams.IMitchWriter, value SymbolStatusTradingStatus) (byteCount int, err error) {
	var n int 
	return byteCount, nil
}
...
func Read_SymbolStatusTradingStatus(stream Streams.IMitchReader) (value SymbolStatusTradingStatus, byteCount int, err error) {
	value = NewSymbolStatusTradingStatus()
	var n int 
	return value, byteCount, nil
}
...
func Write_SymbolStatusSessionChangeReason(stream Streams.IMitchWriter, value SymbolStatusSessionChangeReason) (byteCount int, err error) {
	var n int 
	return byteCount, nil
}
...
func Read_SymbolStatusSessionChangeReason(stream Streams.IMitchReader) (value SymbolStatusSessionChangeReason, byteCount int, err error) {
	value = NewSymbolStatusSessionChangeReason()
	var n int 
	return value, byteCount, nil
}
...
func Write_SymbolStatusBookType(stream Streams.IMitchWriter, value SymbolStatusBookType) (byteCount int, err error) {
	var n int 
	return byteCount, nil
}
...
func Write_MitchMessage_SymbolStatus(stream Streams.IMitchWriter, value *MitchMessage_SymbolStatus) (byteCount int, err error) {
	...
	byteCount += n
	n, err = Write_SymbolStatusTradingStatus(stream, value.TradingStatus)
	if err != nil {
		return 0, err
	}
	byteCount += n
	...
	byteCount += n
	n, err = Write_SymbolStatusSessionChangeReason(stream, value.SessionChangeReason)
	if err != nil {
		return 0, err
	}
	byteCount += n
	...
	byteCount += n
	n, err = Write_SymbolStatusBookType(stream, value.BookType)
	if err != nil {
		return 0, err
	}
	byteCount += n
...
func Read_MitchMessage_SymbolStatus(stream Streams.IMitchReader) (value *MitchMessage_SymbolStatus, byteCount int, err error) {
	...
	byteCount += n
	value.TradingStatus, n, err = Read_SymbolStatusTradingStatus(stream)
	if err != nil {
		return nil, 0, err
	}
	byteCount += n
	...
	byteCount += n
	value.SessionChangeReason, n, err = Read_SymbolStatusSessionChangeReason(stream)
	if err != nil {
		return nil, 0, err
	}
	byteCount += n
	...
	byteCount += n
	value.BookType, n, err = Read_SymbolStatusBookType(stream)
	if err != nil {
		return nil, 0, err
	}
	byteCount += n
...
// OrderSide writer 
func Write_OrderSide(stream Streams.IMitchWriter, value OrderSide) (byteCount int, err error) {
	var n int 
	return byteCount, nil
}
...
func Write_MitchMessage_AddOrder(stream Streams.IMitchWriter, value *MitchMessage_AddOrder) (byteCount int, err error) {
	...
	byteCount += n
	n, err = Write_OrderSide(stream, value.Side)
	if err != nil {
		return 0, err
	}
	byteCount += n
...
func Read_MitchMessage_AddOrder(stream Streams.IMitchReader) (value *MitchMessage_AddOrder, byteCount int, err error) {
	...
	byteCount += n
	value.Side, n, err = Read_OrderSide(stream)
	if err != nil {
		return nil, 0, err
	}
	byteCount += n
...
func Write_OrderBookClearSubBook(stream Streams.IMitchWriter, value OrderBookClearSubBook) (byteCount int, err error) {
	var n int 
	return byteCount, nil
}
...
func Read_OrderBookClearSubBook(stream Streams.IMitchReader) (value OrderBookClearSubBook, byteCount int, err error) {
	value = NewOrderBookClearSubBook()
	var n int 
	return value, byteCount, nil
}
...
func Write_OrderBookClearBookType(stream Streams.IMitchWriter, value OrderBookClearBookType) (byteCount int, err error) {
	var n int 
	return byteCount, nil
}
...
func Read_OrderBookClearBookType(stream Streams.IMitchReader) (value OrderBookClearBookType, byteCount int, err error) {
	value = NewOrderBookClearBookType()
	var n int 
	return value, byteCount, nil
}
...
func Write_MitchMessage_OrderBookClear(stream Streams.IMitchWriter, value *MitchMessage_OrderBookClear) (byteCount int, err error) {
	...
	byteCount += n
	n, err = Write_OrderBookClearSubBook(stream, value.SubBook)
	if err != nil {
		return 0, err
	}
	byteCount += n
	n, err = Write_OrderBookClearBookType(stream, value.BookType)
	if err != nil {
		return 0, err
	}
	byteCount += n
...
func Read_MitchMessage_OrderBookClear(stream Streams.IMitchReader) (value *MitchMessage_OrderBookClear, byteCount int, err error) {
	...
	byteCount += n
	value.SubBook, n, err = Read_OrderBookClearSubBook(stream)
	if err != nil {
		return nil, 0, err
	}
	byteCount += n
	value.BookType, n, err = Read_OrderBookClearBookType(stream)
	if err != nil {
		return nil, 0, err
	}
	byteCount += n
